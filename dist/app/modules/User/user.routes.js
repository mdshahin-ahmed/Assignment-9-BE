...
userRoute.post("/register-admin", (0, validateData_1.default)(user_validation_1.userValidation.registerUserValidation), user_controller_1.userController.createAdmin);
userRoute.get("/user", user_controller_1.userController.getUser);
userRoute.get("/users", (0, auth_1.default)(), user_controller_1.userController.getUsers);
...
userRoute.put("/change-password", (0, auth_1.default)(), user_controller_1.userController.changePassword);
userRoute.put("/user/:userId", (0, auth_1.default)(), user_controller_1.userController.updateUser);
